...
class StrategyMarketMaker(Marketmaker):
    ...
    def submit_all_buy_sell(self):
        ...
        for symbol in asset_syms[:]:
            ...
            if bin_between:
                pip = 0.0000001
                target_bid = bin_avg_price - pip
                target_ask = bin_avg_price + pip
...
#     pip = 0.0001
#     #target_price = topask - pip
#     target_price = topbid * (1 + 0.005)
#     print ("avg ",symbol," >> ",target_price)
#     target_bal_eth = 5
#     qty = round(target_bal_eth/target_price,0)
#     otype = "BUY"
...
#     print ("midprice ",midprice)
#     pip = 0.00001
#     target_price = topbid * (1 + 0.0015)
#     #target_price = topbid + pip
#     #target_price = topask * (1 - 0.008)
#     print ("avg ",symbol," >> ",target_price)
#     qty = 700
#     otype = "SELL"
#     order = [otype, symbol, target_price, qty]
